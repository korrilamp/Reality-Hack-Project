...
namespace QCHT.Samples.Proximal.Scripts
{
    ...
    public class CubeAppearanceFeedback : MonoBehaviour
    {
        ...
        private void OnProximalEnter()
        {
            _triggerCount++;
            UpdateAppearance();
        }

        private void OnProximalExit()
        {
            _triggerCount--;
        ...
        private void OnProximalGrab()
        {
            _isGrabbed = true;
            UpdateAppearance();
        }

        private void OnProximalRelease()
        {
            _isGrabbed = false;
            UpdateAppearance();
        }
